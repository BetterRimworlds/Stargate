...
public class ITab_Pawn_GateTravelerResearch : ITab
{
    ...
    public override bool IsVisible
    {
        get
        {
            ...
            // Tab is injected on Human; still require implant + humanlike.
            GateTravelerImplant implant = GetGateTravelerImplant(pawn);

            return implant != null && pawn.RaceProps?.Humanlike == true;
        }
    }
